// SITE-III Line Closure Detail View
export default function SiteIIILineClosure() {
  const monthlyData = [
    { month: 'July', approved: 653, notApproved: 0, total: 653, approvalRate: '100.00%' },
    { month: 'August', approved: 673, notApproved: 8, total: 681, approvalRate: '98.83%' },
    { month: 'September', approved: 385, notApproved: 6, total: 391, approvalRate: '98.47%' },
    { month: 'October', approved: 243, notApproved: 5, total: 248, approvalRate: '97.98%' },
    { month: 'November', approved: 505, notApproved: 10, total: 515, approvalRate: '98.06%' }
  ];

  const totalApproved = 2459;
    ...
    <div style={{ padding: '40px', background: '#f8fafc', minHeight: '100%' }}>
      ...
      <div style={{
        ...
        <h3 style={{
          ...
          <span style={{ WebkitTextFillColor: '#8b5cf6' }}>📊</span> Monthly Closure Trend
        </h3>
