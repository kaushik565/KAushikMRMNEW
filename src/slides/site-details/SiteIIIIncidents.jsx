...
export default function SiteIIIIncidents() {
  const periods = ['Jan-May', 'Jun-Aug', 'Sep', 'Oct', 'Nov']
  const avgClosure = [24.2, 25, 14, 23, 17]
  const avgInvestigation = [3.6, 25, 7, 1, 4]
  const counts = [53, 5, 13, 4, 7]
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
          <div style={{ display: 'flex', alignItems: 'flex-start', gap: '12px' }}>
            ...
            <div>
              ...
              <div style={{ fontSize: '0.85em', color: '#475569', lineHeight: '1.5' }}>
                Closure days improved {improvementPct}% from baseline 24.2 to best 14 in September.
              </div>
            </div>
          </div>
          ...
          <div style={{ display: 'flex', alignItems: 'flex-start', gap: '12px' }}>
            ...
            <div>
              ...
              <div style={{ fontSize: '0.85em', color: '#475569', lineHeight: '1.5' }}>
                September delivered best closure (14 days) with moderate volume (13 IRs).
              </div>
            </div>
          </div>
          ...
          <div style={{ display: 'flex', alignItems: 'flex-start', gap: '12px' }}>
            ...
            <div>
              ...
              <div style={{ fontSize: '0.85em', color: '#475569', lineHeight: '1.5' }}>
                Jan-May carries 65% of IRs (53/82); later months show lower volume with mixed cycle times.
              </div>
            </div>
          </div>
        </div>
