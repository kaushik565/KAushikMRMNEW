...
export default function SiteVIncidents() {
  ...
  const janMayAvgClosure = 17
  const janMayIRs = 111
  const junNovAvgClosure = (15 * 16 + 11 * 19 + 17 * 7) / (15 + 11 + 17) // weighted average
  const junNovIRs = 15 + 11 + 17
